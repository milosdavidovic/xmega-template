...
/***************************************************************************\
|* Note: It is required to set F_CPU in util/delay.h for delay_us function
|* to work properly, because precise timing is important for one wire
|* See: http://www.nongnu.org/avr-libc/user-manual/group__util__delay.html
****************************************************************************\

***************************************************************************\
|* Note: Library can only use defined ONEWIRE_PORT, if there are onewire 
|*		 interfaces on different ports required, library needs modifications 
****************************************************************************
...
****************************************************************************/
//These are defined in peripherals.h
//#define     	ONEWIRE_PORT        		PORTK.OUT    // 1-Wire PORT Data
//#define     	ONEWIRE_IN         	 		PORTK.IN     // 1-Wire Input pin
//#define     	ONEWIRE_DIR         		PORTK.DIR    // 1-Wire Data direction
...
|* API - Bit functions
****************************************************************************/
void oneWireInit(oneWireDevice *, unsigned char pins );
